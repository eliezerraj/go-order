...
RANDOM_VAL=$((RANDOM % 99 + 1))

URL_POST="${URL_HOST}/order"
PAYLOAD='{"user_id": "siege","currency": "BRL","address": "st. a","cart":{"user_id": "eliezer","cart_item":[{"product": {"sku": "BEER-'$RANDOM_INV'"},"currency": "BRL","quantity": 1'${RANDOM_VAL}',"price": '${RANDOM_VAL}'},{"product": {"sku": "MOBILE-'$RANDOM_INV'"},"currency": "BRL","quantity": '${RANDOM_VAL}',"price": '${RANDOM_VAL}' }]}}'
